			...
			<div class="carousel-inner">
			  ...
			  <ul class="thumbnails">
               <?php include('config.php');
												$log=mysql_query("select * from product  where status='1' limit 4");
				  ...
				  <div class="thumbnail">
				  <i class="tag"></i>
					<a href="product_details.php?id=<?=$row['id']?>"><img src="admin/<?=$row['image']?>" alt=""></a>
					<div class="caption">
					  <h5><?=$row['product_name']?></h5>
					  <h4><a class="btn" href="product_details.php?id=<?=$row['id']?>">VIEW</a> <span class="pull-right"><img src="rupee.png"  style="height:18px; margin-top:0px"?> <?=$row['price']?></span></h4>
					</div>
				  </div>
				</li>
                                                    <?php } ?>
				...
				<li class="span3">
				  <div class="thumbnail">
					...
					<div class="caption">
					  ...
					  <h4 style="text-align:center"><a class="btn" href="product_details.php?id=<?=$row['id']?>"> <i class="icon-zoom-in"></i></a> <a class="btn" href="#" onClick="cart('<?=$row['id']?>','<?=$row['product_type']?>','<?=$row['price']?>');">Add to <i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#"><img src="rup1.png"  style="height:18px; margin-top:-5px; padding:-5px"?> <?=$row['price']?></a></h4>
					</div>
				  </div>
				</li>
                <?php } ?>
