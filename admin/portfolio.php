	  				...
	  				<div class="col-md-12">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title">Product Upload</div>
							  ...
							  if(isset($_GET['msg']))
{
	...
	{
	?>
  <p align="center" style="color:#F00">Product not updated</p>
  
  <?php
	}
	else	{
	?>
  <p align="center" style="color:#F00">Product Updated</p>
  <?php
	}
}
?>
	  				...
	  				<div class="col-md-6">
										...
										<div class="form-group">
											...
											<div >
												...
												$log=mysql_query("select * from category_list where status='1'");
	  				...
	  				<div class="col-md-6">
                                         ...
                                         <div class="form-group">
											...
											<input class="form-control" placeholder="Text field" type="text" name="price">
										</div>
                              </div>
	  				<div class="col-md-6">
  					...
  					<div class="content-box-large">
						...
						?>
                                ...
                                <td><?php echo $s=$s+1;?></td>
				                  <td><a href="portfolio_edit.php?p_id=<?php echo $row['id'];?>"><?php echo $row['product_name'];?></a></td>
