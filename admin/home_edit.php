...
?>
  ...
  $id= $_GET['p_id'];
						include('config.php');
						$result=mysql_query("select * from home where status='1' and id='$id' ");
	  				...
	  				<div class="col-md-6">
                                         ...
                                         <input class="form-control" placeholder="Text field" type="hidden" name="folio_id" value="<?php echo $row['id'];?>">
											...
											<input class="form-control" placeholder="Text field" type="text" name="pdom1" value="<?php echo $row['title'];?>" >
										</div>
                              </div>
	  				...
	  				<div class="col-md-6">
										<div class="form-group">
											<label >Description</label>
											<div >
												<textarea name="ptag1"><?php echo $row['description']; ?></textarea>
											</div>
										</div>
                                        </div>
